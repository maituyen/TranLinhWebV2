...
namespace MyProject.Migrations
{
    ...
    [Migration("20230530124022_update_hastag_v2")]
    partial class update_hastag_v2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyProject.Models.Async", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject.Models.Bank", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject.Models.Banner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject.Models.BlogHome", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject.Models.Content", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject.Models.CustomerHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject.Models.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject.Models.Hastag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject.Models.History", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject.Models.KeyWord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject.Models.KiotvietCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject.Models.ListShop", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject.Models.Metadatum", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject.Models.OrderSale", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject.Models.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject.Models.ProductContent", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject.Models.ProductMetadatum", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject.Models.ProductTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject.Models.ProductTradeIn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject.Models.Seeding", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject.Models.TagBlog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject.Models.WebConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject.Models.WebConfigImage", b =>
                {
            ...
            modelBuilder.Entity("MyProject.Models.WebConfigKeyword", b =>
                {
                    b.Property<int>("WebconfigId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject.Models.WebConfigProduct", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CategoryBanner", b =>
                {
                    b.HasOne("MyProject.Models.Banner", null)
                        .WithMany()
                    ...
                    b.HasOne("MyProject.Models.Category", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CategoryEvent", b =>
                {
                    b.HasOne("MyProject.Models.Event", null)
                        .WithMany()
                    ...
                    b.HasOne("MyProject.Models.Product", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ContentCategory", b =>
                {
                    ...
                    b.HasOne("MyProject.Models.Content", null)
                        .WithMany()
            ...
            modelBuilder.Entity("KeywordProduct", b =>
                {
                    b.HasOne("MyProject.Models.KeyWord", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MyProject.Models.BlogHome", b =>
                {
                    b.HasOne("MyProject.Models.Blog", "Blog")
                        .WithMany("BlogHomes")
            ...
            modelBuilder.Entity("MyProject.Models.Comment", b =>
                {
                    b.HasOne("MyProject.Models.Customer", "Customer")
                        .WithMany("Comments")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("FK_Comments_Customers");

                    b.HasOne("MyProject.Models.Comment", "Parent")
            ...
            modelBuilder.Entity("MyProject.Models.Image", b =>
                {
                    b.HasOne("MyProject.Models.Category", "Categor")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("MyProject.Models.ProductContent", b =>
                {
                    b.HasOne("MyProject.Models.Content", "Content")
            ...
            modelBuilder.Entity("MyProject.Models.ProductMetadatum", b =>
                {
                    b.HasOne("MyProject.Models.Metadatum", "Metadata")
            ...
            modelBuilder.Entity("MyProject.Models.WebConfigImage", b =>
                {
                    b.HasOne("MyProject.Models.Banner", "Banner")
                    ...
                    b.HasOne("MyProject.Models.WebConfig", "Webconfig")
                        .WithMany("WebConfigImages")
            ...
            modelBuilder.Entity("MyProject.Models.WebConfigKeyword", b =>
                {
                    b.HasOne("MyProject.Models.KeyWord", "Keyword")
            ...
            modelBuilder.Entity("PermissionRole", b =>
                {
                    b.HasOne("MyProject.Models.Permission", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProductComment", b =>
                {
                    b.HasOne("MyProject.Models.Comment", null)
                        .WithMany()
